        ...
        container.innerHTML = `
            ...
            <div class="filters-bar">
                ...
                <div class="filter-actions">
                    <input type="text" class="search-input" placeholder="Buscar proposta..." 
                           onkeyup="dashboard.searchProposals(this.value)">
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="action-btn" onclick="dashboard.viewProposal('${proposal.id}')">
                            <i class="fas fa-eye"></i>
                        </button>
